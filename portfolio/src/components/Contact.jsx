  ...
  return (
    ...
    {footerLinks.map((footerlink) => (
              ...
              className={` flex-col my-4 min-w-[150px `}>
                <h4 className='font-poppins font-semibold xs:text-[16px] sm:text-[20px] leading-[27px]'>
                  {footerlink.title}
                </h4>
                ...
                <ul className='list-none mt-4 '>
                  {footerlink.links.map((link, index) => (
                    <li key={link.name}
                    className={`font-poppins font-normal sm:text-[16px] xs:text-[12px] text-[#2D3845] ${
...
<div className='hidden lg:block flex items-start justify-start '>
        {socialLinks.map((socialLink) => (
              <div key={socialLink.title}>
                <h4 className='font-poppins font-semibold py-5 xs:text-[16px] sm:text-[20px] leading-[27px]'>
                  {socialLink.title}
                </h4>
    ...
    <div className='lg:w-[60%] sm:mt-10 lg:m-0'>
      <h4 className='font-poppins font-semibold xs:text-[16px] sm:text-[20px] xs:my-5 sm:my-4 leading-[27px]'>
          SEND ME A NOTE
      </h4>
    <form
          ...
          >
            ...
            <div className="w-[48%]">
              <input
                ...
                name="name"
                className="px-3 py-3 placeholder-gray-400 text-gray-600 bg-white border border-[#dee2e6] rounded-lg w-full xs:text-[12px] sm:text-[16px]"
                required
              />
            </div>
            ...
            <div className="mb-3 pt-0">
              <textarea
                ...
                name="message"
                className="px-3 py-3 h-[150px] placeholder-gray-400 text-gray-600 bg-white border border-[#dee2e6] rounded-lg w-full xs:text-[12px] sm:text-[16px] "
                required
              />
            </div>
            ...
            <button
              className="text-white bg-[#20c997]  px-8 py-3 rounded-full font-poppins shadow-[0_2px_4px_0px_rgba(0,0,0,0.25)] xs:text-[12px] sm:text-[16px]"
              type="submit"
            >
                Send Message
            </button>
